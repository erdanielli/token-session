...
final class AttributesNotifier implements SessionListenerNotifier {
    ...
    public void attributeRemoved(HttpSession s, String attrName, Object prevValue) {
        final HttpSessionBindingEvent event = notify(new HttpSessionBindingEvent(s, attrName, prevValue),
    ...
    public void attributeReplaced(HttpSession s, String attrName, Object prevValue, Object newValue) {
        final HttpSessionBindingEvent event = notify(new HttpSessionBindingEvent(s, attrName, newValue),
    ...
    private HttpSessionBindingEvent notify(HttpSessionBindingEvent event,
